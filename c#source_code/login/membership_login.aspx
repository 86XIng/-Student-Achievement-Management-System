<%@ Page Language="C#" AutoEventWireup="true" CodeFile="membership_login.aspx.cs" Inherits="login_membership_login" %>
    ...
    <div class="login">
        ...
        <div id="darkbannerwrap"></div>
         ...
         <%--<input class="loginin" value="登录" lay-submit lay-filter="login" style="width:100%;" type="submit" />--%>
            ...
            <hr class="hr20" />
            <div><a href="../default.aspx">返回</a>&nbsp;&nbsp; <a href="forget_pass.aspx">忘记密码</a> </div>
