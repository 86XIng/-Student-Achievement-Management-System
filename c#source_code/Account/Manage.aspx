<%@ Page Title="管理帐户" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Manage.aspx.cs" Inherits="Account_Manage" %>
        ...
        <div class="col-md-12">
            <section id="passwordForm">
                <asp:PlaceHolder runat="server" ID="setPassword" Visible="false">
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            <asp:Label ID="Label1" runat="server" AssociatedControlID="password" CssClass="col-md-2 control-label">密码</asp:Label>
                            <div class="col-md-10">
                        ...
                        <div class="form-group">
                            <asp:Label ID="Label2" runat="server" AssociatedControlID="confirmPassword" CssClass="col-md-2 control-label">确认密码</asp:Label>
                            <div class="col-md-10">
                        ...
                        <div class="form-group">
                            <div class="col-md-offset-2 col-md-10">
                                <asp:Button ID="Button1" runat="server" Text="设置密码" ValidationGroup="SetPassword" OnClick="SetPassword_Click" CssClass="btn btn-default" />
                            </div>
                        </div>
                    </div>
                </asp:PlaceHolder>
                ...
                <asp:PlaceHolder runat="server" ID="changePasswordHolder" Visible="false">
                    <p>你以 <strong><%: User.Identity.GetUserName() %></strong> 的身份登录。</p>
                    <div class="form-horizontal">
                        <h4>“更改密码”表单</h4>
                        ...
                        <div class="form-group">
                            <div class="col-md-offset-2 col-md-10">
                                <asp:Button ID="Button2" runat="server" Text="更改密码" OnClick="ChangePassword_Click" CssClass="btn btn-default" ValidationGroup="ChangePassword" />
                            </div>
                        </div>
                    </div>
                </asp:PlaceHolder>
                ...
                <asp:ListView ID="ListView1" runat="server"
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <asp:Button ID="Button3" runat="server" Text="删除" CommandName="Delete" CausesValidation="false"
